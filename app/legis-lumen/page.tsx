          ...
          <CarouselContent>
            <CarouselItem>
              <div className="relative aspect-video h-full w-full">
                <DynamicImage url="https://lukaszglica-portfolio.s3.eu-north-1.amazonaws.com/legis-lumen-3.png" />
              </div>
            </CarouselItem>
            <CarouselItem>
              <div className="relative aspect-video h-full w-full">
                <DynamicImage url="https://lukaszglica-portfolio.s3.eu-north-1.amazonaws.com/legis-lumen-1.png" />
              </div>
            </CarouselItem>
            <CarouselItem>
              <div className="relative aspect-video h-full w-full">
                <DynamicImage url="https://lukaszglica-portfolio.s3.eu-north-1.amazonaws.com/legis-lumen-4.png" />
              </div>
            </CarouselItem>
            <CarouselItem>
              <div className="relative aspect-video h-full w-full">
                <DynamicImage url="https://lukaszglica-portfolio.s3.eu-north-1.amazonaws.com/legis-lumen-5.png" />
              </div>
            </CarouselItem>
          </CarouselContent>
